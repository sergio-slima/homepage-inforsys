...
<p align="center">
  <img alt="Logo da Inforsys" src=".img/logo.png" width="75%">
</p>
...
O HomePage da Inforsys é um site constitucional para manter um canal de contato duradouro com todos os tipos de clientes (inclusive com aqueles que não possuem redes sociais), é uma poderosa ferramenta para aumentar o número de clientes, principalmente direcionando acessos do google para este site.

## 🔖 Layout

Você pode visualizar o layout do projeto através [DESSE LINK](https://www.figma.com/file/KZVMq9BqvEt3Lsz0Zpynky/Diagram---DoctorCare-(Inforsys)?node-id=0%3A1). É necessário ter conta no [Figma](https://figma.com) para acessá-lo.
